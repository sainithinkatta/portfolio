...
const Preloader = () => (
  <motion.div exit={{ y: '-100%', transition: { duration: .8, ease: EASE } }} className="fixed inset-0 z-[120] grid place-items-center bg-[#111116] text-white" aria-hidden="true">
    <div className="text-center">
      ...
      <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: .55 }} className="mt-4 text-[10px] font-semibold uppercase tracking-[.24em] text-white/38">Designing intelligent experiences</motion.p>
    </div>
  </motion.div>
);
