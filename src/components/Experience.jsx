...
const Experience = () => {
  return (
    <section id="experience" className="py-32 lg:py-48 border-t border-border">
        ...
        <div className="max-w-4xl mx-auto">
          {experiences.map((experience, index) => (
            <motion.article
              ...
              className="grid md:grid-cols-[200px,1fr] gap-x-12 gap-y-4 py-12 border-b border-border last:border-b-0"
            >
