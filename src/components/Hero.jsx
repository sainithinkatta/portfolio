...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center pt-10 pb-8">
      <div className="container mx-auto px-4 sm:px-6 mt-20">
        <div className="flex flex-col md:flex-row items-center md:items-start text-left">
          ...
          <div className="md:w-1/2 flex flex-col items-center text-center">
            <div className="w-44 h-44 rounded-full bg-gradient-to-tr from-blue-500 via-purple-500 to-pink-500 mb-6 animate-float overflow-hidden">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-6 animate-fade-in delay-100">
              Full Stack Developer
            </p>
          </div>
          {/* Bio */}
          <div className="md:w-1/2 mb-10 md:mb-0">
            <div className="text-muted-foreground text-sm md:text-base leading-relaxed max-w-4xl animate-fade-in">
              <p className="mb-4">
      ...
      {/* Action Buttons */}
      <div className="flex justify-center mt-16 animate-fade-in delay-300 gap-4">
        <Button
          variant="outline"
          size="lg"
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/sainithinkatta/",
              "_blank"
            )
          }
        >
